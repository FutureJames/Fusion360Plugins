        ...
        try:
            ...
            for input in inputs:
                if input.id == 'filename':
                    timelapse.filename = input.value.replace(" ", "_")
...
class HistoryTimelapse:
    def __init__(self, design):
        ...
        self._toolName = "History-Animation_"
        self._saveObj = False
    ...
    def collectFrames(self):
        ...
        for i in range(start, end):
            ...
            for j in range(_interpolationFrames):
                ...
                # Save image.
                outputFilename = outputPath + toolname + filename + '/' + filename + '_' + str(num)
...
def run(context):
    global timelapse
    try:
        ui.messageBox('WARNING: This script will make changes to your file (e.g. break links to referenced components).  You may want to run this on a copy of your design.  If you are unsure you may CANCEL on the next dialog.')
